...
import type { BaseLink, BaseNode, GraphProps, SelectedNode } from "./types";
...
const DefaultNode = () => (
  <circle fill="black" r={10} className="_graphNode" data-testid="node" />
);

const DefaultLink = () => (
  <line stroke="grey" className="_graphLine" data-testid="link" />
);
