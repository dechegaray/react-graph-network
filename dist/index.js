...
var isNodeDatum = function isNodeDatum(subject) {
...
var addDrag = function addDrag(node, simulation, enableDrag, pullIn) {
  if (enableDrag) {
    node.call(drag().subject(function (event) {
    ...
    node.call(drag().subject(function (_, event) {
      return simulation.find(event.x, event.y);
...
var findNodeBranchFactory = function findNodeBranchFactory(links) {
  var relationsSource = new Map();
  var relationsTarget = new Map();
  for (var _iterator = _createForOfIteratorHelperLoose(links), _step; !(_step = _iterator()).done;) {
    var item = _step.value;
    var target = item.target;
    var source = item.source;
    var targetSet = relationsTarget.get(target.id) || new Set();
    var sourcetSet = relationsSource.get(source.id) || new Set();
  ...
  var findBranch = function findBranch(source, prev, target) {
    var items = source.get(target);
    ...
    itemsArr.forEach(function (i) {
      return findBranch(source, prev, i);
    });
  };
...
var focusNodes = function focusNodes(ids, _ref) {
  var node = _ref.node,
    link = _ref.link,
    _ref$hoverOpacity = _ref.hoverOpacity,
    hoverOpacity = _ref$hoverOpacity === void 0 ? 1 : _ref$hoverOpacity;
  var branchIds = new Set(ids);
  node.style('opacity', function (i) {
    return branchIds.has(i.id) ? '1' : hoverOpacity;
  });
  link.style('opacity', function (i) {
    var nodeId = isNodeDatum(i.source) ? i.source.id : null;
    return nodeId && branchIds.has(nodeId) ? '1' : hoverOpacity;
  });
};
var focusClear = function focusClear(_ref2) {
  var node = _ref2.node,
    link = _ref2.link;
  node.style('opacity', '1');
  link.style('opacity', '1');
};
var addHoverFocus = function addHoverFocus(findBranch, _ref3) {
  var node = _ref3.node,
    link = _ref3.link,
    hoverOpacity = _ref3.hoverOpacity,
    focusNodeBranchIds = _ref3.focusNodeBranchIds;
  node.on('mouseover', function (_, item) {
...
var Graph = function Graph(_ref) {
  ...
  var data = _ref.data,
    ...
    focusNodeBranch = _ref.focusNodeBranch,
    _ref$hoverOpacity = _ref.hoverOpacity,
    hoverOpacity = _ref$hoverOpacity === void 0 ? 1 : _ref$hoverOpacity,
    _ref$nodeDistance = _ref.nodeDistance,
    nodeDistance = _ref$nodeDistance === void 0 ? 300 : _ref$nodeDistance,
    _ref$id = _ref.id,
    ...
    _selectNode = _ref.selectNode;
  React.useEffect(function () {
    if (!data) return;
    var svg = select("#" + id);
    var parentElement = svg.select('* > g').node();
    var link = svg.selectAll('._graphLine').data(data.links);
    var node = svg.selectAll('._graphNode').data(data.nodes);
    var simulation = forceSimulation(data.nodes).force('link', forceLink().id(function (d) {
      return d.id;
    }).links(data.links)).force('charge', forceManyBody().strength(function (node) {
      var _node$gForce;
      return (_node$gForce = node.gForce) != null ? _node$gForce : -nodeDistance;
    })).force('center', forceCenter(parentElement.clientWidth / 2, parentElement.clientHeight / 2)).on('tick', function () {
      return tick(node, link);
    });
    var findNodeBranch = findNodeBranchFactory(data.links);
    var focusNodeBranchIds = focusNodeBranch ? findNodeBranch(focusNodeBranch) : [];
    ...
    addHoverFocus(findNodeBranch, {
      ...
      link: link,
      hoverOpacity: hoverOpacity,
      focusNodeBranchIds: focusNodeBranchIds
    });
    addDrag(node, simulation, enableDrag, pullIn);
  }, [id, data, pullIn, enableDrag, hoverOpacity, focusNodeBranch, nodeDistance]);
  var isFirstNodeSimulated = (data === null || data === void 0 ? void 0 : (_data$nodes = data.nodes) === null || _data$nodes === void 0 ? void 0 : _data$nodes[0].id) === undefined;
  if (isFirstNodeSimulated) {
    return null;
  }
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, data === null || data === void 0 ? void 0 : data.links.map(function (link, i) {
    return /*#__PURE__*/React__default.createElement(LinkComponent, {
      key: "link-" + (link.index || i),
      link: link,
      className: '_graphLine'
    });
  }), data === null || data === void 0 ? void 0 : data.nodes.map(function (node) {
...
function Zoom(_ref2) {
  ...
  var matrixStateRef = React.useRef(initialTransformMatrix);
  var _useState = React.useState(initialTransformMatrix),
  ...
  var defaultConstrain = React.useCallback(function (newTransformMatrix, prevTransformMatrix) {
  ...
  var setTransformMatrix = React.useCallback(function (newTransformMatrix) {
  ...
  var applyToPoint = React.useCallback(function (_ref3) {
    var x = _ref3.x,
      y = _ref3.y;
  ...
  var applyInverseToPoint = React.useCallback(function (_ref4) {
    var x = _ref4.x,
      y = _ref4.y;
  ...
  var scale = React.useCallback(function (_ref5) {
  ...
  var translate = React.useCallback(function (_ref6) {
  ...
  var setTranslate = React.useCallback(function (_ref7) {
  ...
  var translateTo = React.useCallback(function (_ref8) {
    var x = _ref8.x,
      y = _ref8.y;
  ...
  var invert = React.useCallback(function () {
    return inverseMatrix(transformMatrix);
  }, [transformMatrix]);
  var toStringInvert = React.useCallback(function () {
    var _invert = invert(),
  ...
  var dragMove = React.useCallback(function (event, options) {
  ...
  var handleWheel = React.useCallback(function (event) {
    event.preventDefault();
  ...
  var handlePinch = React.useCallback(function (state) {
  ...
  var toString = React.useCallback(function () {
    var translateX = transformMatrix.translateX,
      translateY = transformMatrix.translateY,
  ...
  var center = React.useCallback(function () {
    var centerPoint = {
      x: width / 2,
      y: height / 2
    };
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, children(zoom));
}
Zoom.propTypes = {
...
function ParentSize(_ref) {
  ...
  var resize = React.useMemo(function () {
...
var Zoom$1 = function Zoom$1(_ref) {
  var children = _ref.children,
    rest = _objectWithoutPropertiesLoose(_ref, _excluded$2);
  return /*#__PURE__*/React__default.createElement(ParentSize, Object.assign({}, rest), function (_ref2) {
    var width = _ref2.width,
      height = _ref2.height;
    if (!width || !height) return;
    var translateX = (width - width * 0.75) / 2 + 20;
    var translateY = (height - height * 0.75) / 2;
    ...
    return /*#__PURE__*/React__default.createElement(Zoom, {
      width: width,
      height: height,
      scaleXMin: 0.5,
      scaleXMax: 3,
      ...
      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, children({
        ...
        height: height,
        width: width
      }), /*#__PURE__*/React__default.createElement(NavigationControls, {
        zoom: zoom
      }));
    });
  });
...
var _excluded$3 = ["zoom", "width", "height", "DetailsComponent", "centerOnNodeClick"];
var GraphWithZoom = function GraphWithZoom(_ref) {
  var _props$data, _props$data$nodes, _props$data$nodes$;
  var zoom = _ref.zoom,
    width = _ref.width,
    height = _ref.height,
    DetailsComponent = _ref.DetailsComponent,
    _ref$centerOnNodeClic = _ref.centerOnNodeClick,
    centerOnNodeClick = _ref$centerOnNodeClic === void 0 ? false : _ref$centerOnNodeClic,
  ...
  var firstNodeId = (_props$data = props.data) === null || _props$data === void 0 ? void 0 : (_props$data$nodes = _props$data.nodes) === null || _props$data$nodes === void 0 ? void 0 : (_props$data$nodes$ = _props$data$nodes[0]) === null || _props$data$nodes$ === void 0 ? void 0 : _props$data$nodes$.id;
  var centerCanvasToNode = React.useCallback(function (node) {
    var scale = zoom.transformMatrix.scaleX;
    zoom.setTranslate({
  ...
  }, /*#__PURE__*/React__default.createElement(Graph, Object.assign({}, props, {
    focusNodeBranch: selectedNode === null || selectedNode === void 0 ? void 0 : selectedNode.id,
    selectNode: function selectNode(node) {
      setSelectedNode(node);
    }
  })))), selectedNode && DetailsComponent && /*#__PURE__*/React__default.createElement(DetailsComponent, {
    node: selectedNode,
...
var NetworkGraph = function NetworkGraph(props) {
  return /*#__PURE__*/React__default.createElement(Zoom$1, {
    ...
    var zoom = _ref2.zoom,
      height = _ref2.height,
      width = _ref2.width;
    return /*#__PURE__*/React__default.createElement(GraphWithZoom, Object.assign({}, props, {
      zoom: zoom,
      width: width,
      height: height
    }));
